...
if present_value >= loan.get("loan_price",""):
    ...
    print("The present value is worth less than the cost of the loan.")
...
def loaner(future_value, remaining_months):
    present_value_new = (future_value)/(1+.2/12)**remaining_months
    print (present_value_new)
loaner(future_value, remaining_months)
